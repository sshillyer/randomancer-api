// These basic mongodb query functions generated by yeoman generator:
...
class Controller {
  ...
  update(req, res, next) {
    ...
    .then(doc => {
      if (!doc) { return res.status(404).end(); }
//      return res.status(200).json(doc); // original return value
        // We want our updates to return the result of our update call
